...
import CustomerEditProfileComponent from "../profiles/pages/customer-edit-profile.component.vue";
...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/customer-edit',   name: 'customer-edit-profile', component: CustomerEditProfileComponent, meta: { title: 'Customer Edit Profile' } },
