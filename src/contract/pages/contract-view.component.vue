...
export default {
  ...
  methods: {
    exportToPdf() {
      let element = document.getElementById('contract-content');
      let opt = {
        margin: 1,
...
<div id="contract-content">
  <h3>CONTRACT FOR MUSICAL PRESENTATION</h3>
  <pv-divider />
  <div class="card">
    <h5>DECLARACIONES</h5>
    <p class="m-0">
    ...
    <pv-divider />
    <h5>TERMINACIÓN DEL CONTRATO</h5>
    <p class="m-0">
